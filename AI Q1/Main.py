...
class Greetings(KnowledgeEngine):
	...
	def _initial_action(self):
		print("")
		print("Hi! I am a Diagnosis Expert System, I am here to help you make your health better.")
		print("For that you'll have to answer a few questions about your conditions.Please reply with Yes/No")
	...
	def symptom_12(self):
		self.declare(Fact(blurred_vision=input("Blurred_vision: ").strip().lower()))
	...
	def not_matched(self,headache, back_pain, chest_pain, cough, fainting, sore_throat, fatigue, restlessness,low_body_temp ,fever ,sunken_eyes ,nausea ,blurred_vision):
		...
		symlis = ["Headache", "Backpain", "Chestpain", "Cough", "Fainting", "Sore Throat", "Fatigue", "Restlessness","Low Body Temp" ,"Fever" ,"Sunken eyes" ,"Nausea" ,"Blurred vision"]
		print("For the following Symptoms:")
